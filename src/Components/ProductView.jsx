...
const ProductView = ({selectedProduct, addToCart, cartItems}) => {
    ...
    console.log(`Selected products: ${JSON.stringify(selectedProduct)}`);
    console.log(cartItems)
    return(
        <div className="d-flex justify-content-center align-items-center container-fluid">
            <div className="d-flex flex-column flex-lg-row justify-content-center align-items-center product-view-container px-2 my-5 my-md-0">
                ...
                <div>
                    ...
                    <Button variant="outline-secondary" size="sm" onClick={handleAddToCart}>Add to Cart</Button>
                </div>
                </div>
            </div>
        </div>
